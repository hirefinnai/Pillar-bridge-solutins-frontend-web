...
function CallToAction() {
  return (
    <section className="py-8 bg-customBg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-white p-8 sm:p-10 flex flex-col lg:flex-row justify-around items-center space-y-0 lg:space-y-0 lg:space-x-2">
          {/* Text content */}
